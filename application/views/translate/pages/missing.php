<h1><?php echo Yii::t('onlinecourseportal', 'Missing Translations')." - ".Yii::app()->translate->acceptedLanguages[Yii::app()->getLanguage()]?></h1>
<?php 
...
$this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
        ...
        array(
            ...
            'buttons'=>array(
                'create'=>array(
                    'label'=>Yii::t('onlinecourseportal', 'Create'),
