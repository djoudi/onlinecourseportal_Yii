...
<h1><?php echo Yii::t('onlinecourseportal', ($action) . ' Message')." # ".$model->id." - ".Yii::app()->translate->acceptedLanguages[$model->language]; ?></h1>
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row buttons">
		<?php echo CHtml::submitButton(Yii::t('onlinecourseportal', $action)); ?>
	</div>
