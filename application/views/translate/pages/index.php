<?php 
    $language = Yii::app()->translate;
    $languageKey = $language::ID; 
    
    $google = !empty(Yii::app()->translate->googleApiKey);
?>
<h2><?php echo Yii::t('onlinecourseportal', 'Translate to {lang}',array('{lang}' => $language->acceptedLanguages[$language->getLanguage()]));?></h2>
<?php
    if($google) {
        echo CHtml::link(Yii::t('onlinecourseportal', 'Translate all with google translate'),"#",array('id'=>$languageKey."-google-translateall"));
        echo CHtml::script(
...
<div class="form">
    ...
    <?php echo CHtml::submitButton(Yii::t('onlinecourseportal', 'Translate'));?>
