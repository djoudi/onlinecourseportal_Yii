...
?>
		...
		<h3><?php echo Yii::t('onlinecourseportal', 'Intro to Caregiving Online'); ?></h3>
		...
		<hr>
			...
			<h3><?php echo Yii::t('onlinecourseportal', 'Empower Online'); ?></h3>
		...
		<hr>
			...
			<h3><?php echo Yii::t('onlinecourseportal', 'CARE Coaching Online'); ?></h3>
		...
		<hr>
					...
					<h3><?php echo Yii::t('onlinecourseportal', 'Making Sense of of Memory Loss (MSML) Online'); ?></h3>
		...
		<hr>
					...
					<h3><?php echo Yii::t('onlinecourseportal', 'Gerontology Online program'); ?></h3>
