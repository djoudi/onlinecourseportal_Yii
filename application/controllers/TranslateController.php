...
class TranslateController extends OnlineCoursePortalController {
	...
	public function actionIndex() {
        ...
        if(count($postMissing)) {
            ...
            $this->renderText(Yii::t('onlinecourseportal', 'All messages translated'));
            Yii::app()->end();
        }
    ...
    function actionGoogletranslate(){
        if(Yii::app()->getRequest()->getIsPostRequest()){
            $translation=Yii::app()->translate->googleTranslate($_POST['message'],$_POST['language'],$_POST['sourceLanguage']);
    ...
    public function actionCreate($id,$language)
    {
    	...
    	$this->render('pages/createUpdate',array('model'=>$model));
    }
    /**
     * Updates a particular model.
     * If update is successful, the browser will be redirected to the 'view' page.
    ...
    public function actionDelete($id,$language)
    {
    	if(Yii::app()->getRequest()->getIsPostRequest()){
    		...
    		if($model->delete()){
    			if(Yii::app()->getRequest()->getIsAjaxRequest()){
    				echo Yii::t('onlinecourseportal', 'Message deleted successfully');
    				Yii::app()->end();
    			}else
    ...
    public function actionAdmin()
    {
    	...
    	$messageSource->language = Yii::app()->language;
    
    	$this->render('pages/admin',array(
    			'message' => $message,
    ...
    public function actionMissing() {
    	...
    	$this->render('pages/missing',array(
    			'model' => $messageSource,
    	));
    }
