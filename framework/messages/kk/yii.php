...
return array (
  ...
  'CDbConnection failed to open the DB connection: {error}' => 'CDbConnection дерекқормен байланысты орната алмады: {error}',
  'CDbConnection.connectionString cannot be empty.' => 'CDbConnection.connectionString параметрі бос болмауы тиіс.',
  'Your request is not valid.' => 'Сұранымда қате табылды.',
  ...
  'CHttpSession.gcProbability "{value}" is invalid. It must be an integer between 0 and 100.' => 'CHttpSession.gcProbability параметрінің "{value}" мәні қате. Ол 0 мен 100 арасындағы сан болуы тиіс.',
  ...
  'GD and FreeType PHP extensions are required.' => 'PHP GD мен FreeType кеңейтулері керек.',
